    ...
    public static void alteraViewVendaSelecionada() {
        ...
        if (venda.getCliente() != null) {
            if (venda.getCliente().getId() > 0) {
                ...
                VariaveisControleAndroid.textViewVendaSelectionada.setText(
                        "Venda: "+venda.getId()+"\nCliente: " + nome);
            } else {
                VariaveisControleAndroid.textViewVendaSelectionada.setText(
        ...
        alteraValorButtonFinalizarVendaSelecionada();
    }

    public static void alteraValorButtonFinalizarVendaSelecionada() {
        Venda venda = VariaveisControleG.vendaSelecionada;
